...
fun setPageData(recyclerView: RecyclerView, pageData:PagedList<Any>, @LayoutRes pagetItemLayout:Int, itemClick: BaseBindingAdapter.OnItemClickListener<Any>?, itemEventHandler: Any?){
    val adapter = recyclerView.adapter
    if(adapter == null){
        val simplePageAdapter = SimplePageAdapter(pagetItemLayout)
        ...
        (adapter as BasePageAdapter<Any,ViewDataBinding>).submitList(pageData)
...
fun setPageData(recyclerView: RecyclerView, data: PagedList<Any>, @LayoutRes pagetItemLayout: Int){
    setPageData(recyclerView,data,pagetItemLayout,null,null)
}

@BindingAdapter("pageData","pageItemLayout","itemClick")
fun setPageData(recyclerView: RecyclerView, data: PagedList<Any>, @LayoutRes pagetItemLayout: Int,itemClick: BaseBindingAdapter.OnItemClickListener<Any>){
    setPageData(recyclerView,data,pagetItemLayout,itemClick, null)
}

@BindingAdapter("pageData","pageItemLayout","itemEventHandler")
fun setPageData(recyclerView: RecyclerView, data: PagedList<Any>, @LayoutRes pagetItemLayout: Int,itemEventHandler: Any){
    setPageData(recyclerView,data,pagetItemLayout,null,itemEventHandler)
}
